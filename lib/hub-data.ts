...
export const SITE = {
  ...
  subtitle:
    "A public, organized record of documents and information regarding the Bricks & Minifigs situation involving Reckless Ben's Investigative Documentary Series.",
